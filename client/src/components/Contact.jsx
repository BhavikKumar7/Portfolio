...
//                         document.getElementById('dialDisplay').textContent = selectedCode;
//                       }}
//                       defaultValue="+91"
//                       required
//                     >
...
//                 whileTap={{ scale: 0.97 }}
//                 type="submit"
//                 className="w-full bg-teal-500 hover:bg-teal-400 text-black font-semibold text-base sm:text-lg py-3 rounded-xl transition-all duration-300 shadow-md hover:shadow-teal-500/30"
//               >
//                 Send Message
//               </motion.button>
//             </motion.form>
